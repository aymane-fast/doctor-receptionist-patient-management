    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                <h2 class="text-xl font-semibold text-gray-900 mb-4">Patient & Visit Information</h2>
                ...
                <div class="border-b pb-4 mb-4">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                        <div>
                            ...
                            <p class="font-semibold">{{ $medicalRecord->patient->age }} years</p>
                        </div>
                        <div>
                            <label class="block text-gray-500">Gender</label>
                            <p class="font-semibold">{{ ucfirst($medicalRecord->patient->gender) }}</p>
                        </div>
                        <div>
                            <label class="block text-gray-500">Blood Type</label>
                            <p class="font-semibold">{{ $medicalRecord->patient->blood_type ?: 'Not specified' }}</p>
                        </div>
                        <div>
                            <label class="block text-gray-500">Emergency Contact</label>
                            <p class="font-semibold">{{ $medicalRecord->patient->emergency_contact ?: 'Not specified' }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium
                            ...
                            @endif">
                            {{ ucfirst(str_replace('-', ' ', $medicalRecord->visit_type)) }}
                        </span>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                    ...
                    <div class="text-center p-4 bg-pink-50 rounded-lg">
                        ...
                        <p class="text-lg font-bold text-gray-900">{{ $medicalRecord->heart_rate }} bpm</p>
                    </div>
                    @endif
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <div class="space-y-6">
                    <!-- Chief Complaint -->
                    <div>
                        <label class="block text-sm font-medium text-gray-500 mb-2">Chief Complaint</label>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-500 mb-2">History of Present Illness</label>
                        <div class="bg-gray-50 rounded-lg p-4">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-500 mb-2">Physical Examination</label>
                        <div class="bg-gray-50 rounded-lg p-4">
                    ...
                    <!-- Diagnosis -->
                    <div>
                        <label class="block text-sm font-medium text-gray-500 mb-2">Assessment/Diagnosis</label>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-500 mb-2">Treatment Plan</label>
                    ...
                    <div class="pt-3 border-t">
                        <a href="{{ route('appointments.show', $medicalRecord->appointment) }}" 
                           class="text-blue-600 hover:text-blue-800 transition-colors">
                            <i class="fas fa-calendar mr-1"></i>View Related Appointment
                        </a>
                    </div>
                    @endif
                </div>
