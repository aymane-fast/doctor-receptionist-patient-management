            ...
            <div class="flex items-center space-x-3">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">
                        <span class="text-gradient">Create Medical Record</span>
                    </h1>
                    <p class="text-gray-600 mt-1">Document patient visit and diagnosis</p>
                </div>
            </div>
            ...
            <form action="{{ route('medical-records.store') }}" method="POST" class="space-y-6">
                ...
                <div class="p-6 pb-0">
                    <div class="flex items-center space-x-3 mb-4">
                        ...
                        <h3 class="text-lg font-bold text-gray-900">Patient & Visit Information</h3>
                    </div>
                ...
                <div class="p-6">
                    ...
                    <div class="bg-blue-50 rounded-xl p-4 border border-blue-200">
                        <div class="flex items-center space-x-2 mb-3">
                            ...
                            <h4 class="font-semibold text-blue-800">Vital Signs (Optional)</h4>
                        </div>
