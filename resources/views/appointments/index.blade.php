    ...
    <div class="bg-white rounded-lg shadow p-6">
        <form method="GET" action="{{ route('appointments.index') }}" class="grid grid-cols-1 md:grid-cols-5 gap-4">
            <div>
                ...
                <input type="text" id="search" name="search" value="{{ request('search') }}" placeholder="Name, Patient ID, Phone, ID card" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500">
            </div>
            <div>
